...
def evaluate(data_name, prompt_type, samples: list=None, file_path: str=None, max_num_samples=None, execute=False, args=None):
    ...
    print(f'[suppression_token] {args.suppression_token}')
    print(f'[token_scale_factor] {args.token_scale_factor}')
    print(f'[tokenid_file_path] {args.tokenid_file_path}')
    print(f'[tokenid_rank] {args.tokenid_rank}')
    print(f'[tokenid_previous_rank] {args.tokenid_previous_rank}')
    print(result_json)
    print('='*50)
