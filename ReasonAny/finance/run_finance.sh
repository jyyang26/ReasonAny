...
# 修改点：FinanceQA Domain Dataset (提取 QUERY 和 ANSWER)
export DOMAIN_DATASET_PATH="FinanceQA/0000.parquet"

# Reasoning Dataset (OpenThoughts Math)
export REASONING_DATASET_PATH="OpenThoughts-114k-math/data/train-00000-of-00005.parquet"

# --- 2. 配置輸出和超參數 ---

# 修改点：Output Path (对应 Llama 8B)
...
echo "Domain Model: $DOMAIN_MODEL_PATH"
